            ...
            <div className="max-w-2xl mx-auto text-center space-y-12">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex justify-center gap-4">
                        <a href={`https://linkedin.com/in/${linkedin}`} className="p-2 text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                            <Linkedin size={24} />
                        </a>
                        {/* Placeholders for others */}
                        <span className="p-2 text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors cursor-pointer">
                            <Github size={24} />
                        </span>
                        <span className="p-2 text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors cursor-pointer">
